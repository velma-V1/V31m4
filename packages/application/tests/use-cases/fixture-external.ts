import { ArtifactId, CheckpointId, ProjectId, SafePath, Score } from "@v31m4/domain";
import type {
  ModelGatewayPort,
  PluginRegistryPort,
...
import { createEvidence, createVerification, T0, type TestClock } from "./fixture-core.js";
...
export function createExternalPorts(state: ExternalState) {
  ...
  const workspaces: WorkspaceManagerPort = {
    ...
    discard: async (workspaceId) => {
      state.discardedWorkspaces.push(workspaceId);
    },
  };
