...
import { approvedPluginManifest, context, Harness, modelRequest, toolRequest } from "./fixtures.js";
    ...
    const plugin = await registerPlugin(
      {
        ...
        plugins: harness.pluginRegistry,
        policy: harness.policy,
        approvals: harness.approvalStore,
        audit: harness.audit,
        clock: harness.clock,
      },
      approvedPluginManifest(),
      "audit-plugin-1",
      undefined,
      context,
    );
