...
export class Harness {
  ...
  constructor() {
    ...
    const external = createExternalPorts({
      ...
      get kernelFailure() { return harness.kernelFailure; },
      set kernelFailure(value) { harness.kernelFailure = value; },
      get modelFailure() { return harness.modelFailure; },
      set modelFailure(value) { harness.modelFailure = value; },
      get toolFailure() { return harness.toolFailure; },
      set toolFailure(value) { harness.toolFailure = value; },
    });
