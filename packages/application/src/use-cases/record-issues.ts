import { IssueRecord, type CandidateId, type IssueRecord as IssueRecordType, type IssueSeverity } from "@v31m4/domain";
...
export async function recordIssues(
  ...
  return dependencies.unitOfWork.execute(context, async (transaction) => {
    ...
    for (const draft of drafts) {
      ...
      stored.push(await dependencies.candidates.saveIssue(issue, WriteConditions.mustNotExist(), context, transaction));
    }
