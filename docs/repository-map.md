...
| `/apps/runtime/tests` | Runtime verification | Command, P0 idempotency, negative-verification-path, evidence-durable-readback, restart-recovery, idle-SSE establishment, and real Playwright Chromium regression against a real HTTP server + real SQLite |
