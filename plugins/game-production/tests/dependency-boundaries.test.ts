...
describe("game-production dependency boundary", () => {
  it("imports only application, department-host, Node APIs, and plugin-local modules — never infrastructure or video-production", () => {
