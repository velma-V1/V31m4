...
const ALLOWED_PACKAGES = new Set(["@v31m4/application", "@v31m4/department-host"]);
...
describe("video-production dependency boundary", () => {
  it("imports only application, department-host, Node APIs, and plugin-local modules — never infrastructure or game-production", () => {
